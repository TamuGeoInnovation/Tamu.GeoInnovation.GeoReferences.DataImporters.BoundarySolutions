...
{
    public abstract class AbstractBoundarySolutionsParcelsShapefileFileLayout : AbstractBoundarySolutionsParcelsFileLayout
    {
        ...
        public AbstractBoundarySolutionsParcelsShapefileFileLayout(string tableName)
            : base(tableName) { }
